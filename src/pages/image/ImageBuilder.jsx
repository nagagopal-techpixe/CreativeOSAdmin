// pages/image/ImageBuilder.jsx
import { useEffect, useState } from "react";
import { useSearchParams } from "react-router-dom";
import { fetchUserPermissions } from "../../services/users";
import ImageCategoriesStep from "./ImageCategoriesStep";
import ImageTypesStep from "./ImageTypesStep";
import ImageStylesStep from "./ImageStylesStep";
import ImageDetailsStep from "./ImageDetailsStep";
import ImageRatiosStep from "./ImageRatiosStep";
...
export default function ImageBuilder() {
  ...
  return (
    <div className="p-6 min-h-screen text-slate-200">
      ...
      <ImageCategoriesStep userId={userId} />
      <ImageTypesStep userId={userId} />
      <ImageStylesStep userId={userId} />
      <ImageDetailsStep userId={userId} />
      <ImageRatiosStep userId={userId} />
    </div>
  );
}
