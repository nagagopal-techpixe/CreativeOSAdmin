// pages/music/MusicBuilder.jsx
import { useEffect, useState } from "react";
import { useSearchParams } from "react-router-dom";
import { fetchUserPermissions } from "../../services/users";
import MusicTypesStep from "./MusicTypesStep";
import MusicGenresStep from "./MusicGenresStep";
import MusicDetailsStep from "./MusicDetailsStep";
import MusicDurationsStep from "./MusicDurationsStep";
...
export default function MusicBuilder() {
  ...
  return (
    <div className="p-6 min-h-screen text-slate-200">
      ...
      <MusicTypesStep userId={userId} />
      <MusicGenresStep userId={userId} />
      <MusicDetailsStep userId={userId} />
      <MusicDurationsStep userId={userId} />
    </div>
  );
}
